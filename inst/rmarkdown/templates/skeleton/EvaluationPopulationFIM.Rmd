...
tablesForReport$fimInitialDesignTable$fixedEffectsTable
``` 

## Variance effects 
```{r FimVarianceEffect, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"} 
tablesForReport$fimInitialDesignTable$varianceEffectsTable
``` 
...
tablesForReport$fimInitialDesignTable$SEAndRSETable
``` 
