...
output = generateTables( evaluationObject, plotOptions )
```
...
# Graphs for the SE, RSE and shrinkage

```{r plotSEandRSE, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"} 

plotShrinkage = tablesEvaluationFIMIntialDesignResults$tablesPlot$plotShrinkage
