...
```{r FIMVarianceEffectsTable, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"} 
...
```{r correlationMatrixVarianceEffectsTable, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"} 
