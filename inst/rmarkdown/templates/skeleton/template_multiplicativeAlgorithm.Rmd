...
if ( output$typeOfFIM[1] == "PopulationFim" ){
  plotWeight = TRUE
}
```
...
```{r CriteriaInitialDesign, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"}
output = knitrFIM( object )
output$criteriaFimInitialDesign
```

# Optimal design
```{r Optimal, echo = FALSE, comment='', fig.height = 4, fig.width = 8, fig.align = "center"}
...
```{r plotSE, echo = FALSE, comment='', fig.height = 4, fig.width = 8, fig.align = "center"}
SE =plotSE( object )
print(SE[[1]])
RSE = plotRSE( object )
print(RSE[[1]])
...
`r if ( plotWeight ) '#  Graph for the optimal weights'`
```{r plotWeightOptimisation, eval = plotWeight, echo = FALSE, comment='', fig.height = 4, fig.width = 8, fig.align = "center"}
output = plotWeightOptimisation( object, weightThreshold )
for ( i in 1:length( output$plot[[1]] ) )
{
print(output$plot[[1]][[i]] )
}
```
