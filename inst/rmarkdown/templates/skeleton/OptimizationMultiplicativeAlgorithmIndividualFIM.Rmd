...
# Graphs for the optimal weights
```{r plotWeight, 'results' = FALSE, echo = FALSE, comment='', fig.height = 5, fig.width = 10, fig.align = "center"} 
plotWeights( tablesForReport$pfimproject ) 
``` 
