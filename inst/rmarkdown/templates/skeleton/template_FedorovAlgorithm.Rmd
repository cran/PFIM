...
# Optimal design
```{r Optimal, echo = FALSE, comment='', fig.height = 4, fig.width = 8}
...
```{r plotSE, echo = FALSE, comment='', fig.height = 4, fig.width = 8}
SE =plotSE( object )
print(SE[[1]])
RSE = plotRSE( object )
print(RSE[[1]])
...
`r if ( plotFrequencies ) '#  Graph for the optimal frequencies'`
```{r plotFrequenciesOptimisation, eval = plotFrequencies, echo = FALSE, comment='', fig.height = 4, fig.width = 8, fig.align = "center"}
output = plotFrequenciesOptimisation( object )
